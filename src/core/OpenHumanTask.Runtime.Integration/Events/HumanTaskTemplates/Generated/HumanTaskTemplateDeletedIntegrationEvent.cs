...
namespace OpenHumanTask.Runtime.Integration.Events.HumanTaskTemplates
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired whenever a HumanTaskTemplate has been deleted
	/// </summary>
	[DataContract]
	public partial class HumanTaskTemplateDeletedIntegrationEvent
		: IntegrationEvent
	{
		...
		/// <summary>
		/// The user that has deleted the HumanTask
		/// </summary>
		[DataMember(Name = "user", Order = 3)]
		[Description("The user that has deleted the HumanTask")]

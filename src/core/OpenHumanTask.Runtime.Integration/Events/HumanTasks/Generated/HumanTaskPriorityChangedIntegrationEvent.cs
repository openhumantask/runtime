...
namespace OpenHumanTask.Runtime.Integration.Events.HumanTasks
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired whenever a HumanTask's priority has changed
	/// </summary>
	[DataContract]
	public partial class HumanTaskPriorityChangedIntegrationEvent
		: IntegrationEvent
	{
		...
		/// <summary>
		/// The HumanTask's updated priority
		/// </summary>
		[DataMember(Name = "priority", Order = 4)]
		[Description("The HumanTask's updated priority")]

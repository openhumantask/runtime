...
namespace OpenHumanTask.Runtime.Integration.Events.HumanTasks
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired whenever a HumanTask has been released
	/// </summary>
	[DataContract]
	public partial class HumanTaskReleasedIntegrationEvent
		: IntegrationEvent
	{
		...
		/// <summary>
		/// The user that has released the HumanTask
		/// </summary>
		[DataMember(Name = "user", Order = 3)]
		[Description("The user that has released the HumanTask")]

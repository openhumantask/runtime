...
namespace OpenHumanTask.Runtime.Integration.Events.HumanTasks
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired when a new Comment has been added to a HumanTask
	/// </summary>
	[DataContract]
	public partial class CommentAddedToHumanTaskIntegrationEvent
		: IntegrationEvent
	{
		...
		/// <summary>
		/// The user that has authored the Comment
		/// </summary>
		[DataMember(Name = "user", Order = 3)]
		[Description("The user that has authored the Comment")]

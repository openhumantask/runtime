...
namespace OpenHumanTask.Runtime.Integration.Events.HumanTasks
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired when a HumanTask has been suspended
	/// </summary>
	[DataContract]
	public partial class HumanTaskSuspendedIntegrationEvent
		: IntegrationEvent
	{
		...
		/// <summary>
		/// The reason why the HumanTask has been suspended
		/// </summary>
		[DataMember(Name = "reason", Order = 4)]
		[Description("The reason why the HumanTask has been suspended")]

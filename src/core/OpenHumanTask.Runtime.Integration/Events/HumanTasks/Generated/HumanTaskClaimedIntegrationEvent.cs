...
namespace OpenHumanTask.Runtime.Integration.Events.HumanTasks
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired whenever a HumanTask has been claimed
	/// </summary>
	[DataContract]
	public partial class HumanTaskClaimedIntegrationEvent
		: IntegrationEvent
	{
		...
		/// <summary>
		/// The user that has claimed the HumanTask
		/// </summary>
		[DataMember(Name = "user", Order = 3)]
		[Description("The user that has claimed the HumanTask")]

...
namespace OpenHumanTask.Runtime.Integration.Events.HumanTasks
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired when a HumanTask has been started
	/// </summary>
	[DataContract]
	public partial class HumanTaskStartedIntegrationEvent
		: IntegrationEvent
	{
		...
		/// <summary>
		/// The user that has started the Comment
		/// </summary>
		[DataMember(Name = "user", Order = 3)]
		[Description("The user that has started the Comment")]

...
namespace OpenHumanTask.Runtime.Integration.Events.HumanTasks
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired when a HumanTask has been cancelled
	/// </summary>
	[DataContract]
	public partial class HumanTaskCancelledIntegrationEvent
		: IntegrationEvent
	{
		...
		/// <summary>
		/// The reason why the HumanTask has been cancelled
		/// </summary>
		[DataMember(Name = "reason", Order = 4)]
		[Description("The reason why the HumanTask has been cancelled")]

...
namespace OpenHumanTask.Runtime.Integration.Events.HumanTasks
{
	...
	/// <summary>
	/// Represents the IDomainEvent fired whenever a HumanTask has been delegated
	/// </summary>
	[DataContract]
	public partial class HumanTaskDelegatedIntegrationEvent
		: IntegrationEvent
	{
		...
		/// <summary>
		/// The user that has delegated the HumanTask
		/// </summary>
		[DataMember(Name = "user", Order = 3)]
		[Description("The user that has delegated the HumanTask")]
		public virtual UserReference User { get; set; }

		/// <summary>
		/// The user the HumanTask has been delegated to
		/// </summary>
		[DataMember(Name = "delegatedTo", Order = 4)]
		[Description("The user the HumanTask has been delegated to")]
		public virtual UserReference DelegatedTo { get; set; }

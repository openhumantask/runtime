...
namespace OpenHumanTask.Runtime.Domain.Events.HumanTasks
{
        ...
        : DomainEvent<HumanTask, string>
    {
        ...
        public HumanTaskCreatedDomainEvent(string id, string definitionId, string key, PeopleAssignments peopleAssignments, IDictionary<string, string>? title, IDictionary<string, string>? subject, 

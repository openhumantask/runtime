...
namespace OpenHumanTask.Runtime.Application
{
    ...
    public static class IRepositoryFactoryExtensions
    {
        ...
        /// <param name="modelType">The type of the application data model to create a new <see cref="IRepository"/> for</param>
        /// <returns>A new <see cref="IRepository"/></returns>
        public static IRepository CreateRepository(this IRepositoryFactory factory, Type entityType, ApplicationDataModelType modelType)
        {
            if (entityType == null)

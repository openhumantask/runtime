...
namespace OpenHumanTask.Runtime.Application
{
    ...
    public static class IMediatorExtensions
    {
        ...
        /// <exception cref="OperationException">A new <see cref="OperationException"/> in case errors occured during the <see cref="IRequest"/>'s execution</exception>
        ...
        /// <param name="cancellationToken">A <see cref="CancellationToken"/></param>
        /// <returns>A new awaitable <see cref="Task"/></returns>
        /// <exception cref="OperationException">A new <see cref="OperationException"/> in case errors occured during the <see cref="ICommand"/>'s execution</exception>
        ...
        /// <param name="cancellationToken">A <see cref="CancellationToken"/></param>
        /// <returns>A new awaitable <see cref="Task"/></returns>
        /// <exception cref="OperationException">A new <see cref="OperationException"/> in case errors occured during the <see cref="IQuery"/>'s execution</exception>
